        ...
        <div className="container">
            ...
            <div className="relative">
                <div className="relative z-1 flex items-center h-[39rem] mb-5 p-8 border-n-1/10 rounded-3xl overflow-hidden lg:p-20 xl:h-[46rem]">
                  ...
                  <Generating className="flex items-center h-[3.5rem] px-6 bg-n-8/80 rounded-[1.7rem] absolute left-4 right-4 bottom-4 border-n-1/10 border lg:left-1/2 lg-right-auto lg:bottom-8 lg:-translate-x-1/2 text-base" />
                </div>
                <div className="relative z-1 grid gap-5 lg:grid-cols-2">
                    <div className="relative min-h-[39rem] border border-n-1/10 rounded-3xl overflow-hidden">
                     ...
                     <p className="body-2 mb-[3rem] text-n-3">Automatically enhance you photos sing our AI app&apos;s photo editing feature. Try it now!</p>
                     </div>
                   ...
                   <div className="p-4 bg-n-7 rounded-3xl overflow-hidden lg:min-h-[46rem]">
                    <div className="py-12 px-4 xl:px-8">
                     ...
                     <div className="relative h-[20rem] bg-n-8 rounded-xl overflow-hidden md:h-[25rem]">
                      <img src={service3} className="w-full h-full object-cover" height={400} width={520} alt="Scary robot" />
                       <VideoChatMessage />
                       <VideoBar />
                     </div>
